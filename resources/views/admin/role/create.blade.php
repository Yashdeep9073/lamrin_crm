            ...
            <div class="col-md-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="mb-3">
                            <button type="button" class="btn btn-outline-primary btn-sm" id="select-all">{{ __('Select All') }}</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm" id="unselect-all">{{ __('Unselect All') }}</button>
                        </div>
                        ...
                        <div class="form-group d-inline" style="margin-right: 40px;">
                            <div class="checkbox d-inline m-r-10">
                                <input type="checkbox" id="checkbox-{{ $value->id }}" name="permission[]" value="{{ $value->id }}" checked class="permission-checkbox">
...
<!-- Add JavaScript for Select All/Unselect All -->
<script>
