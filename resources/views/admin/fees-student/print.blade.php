...
<head>
    ...
    <style type="text/css" media="print">
        @media print {
            ...
            /* Container scaling and page break control */
            .template-container {
                transform: scale(1.0);
            ...
            .remark-content {
                ...
                /* Changed from break-all for better readability */
...
<body>
            ...
            <table class="table-no-border top-meta-table">
                <tbody>
                    <tr>
                        ...
                        <td class="meta-data">{{ __('Receipt No') }}</td>
                        <td class="meta-data value">: {{ str_pad($row->id, 6, '0', STR_PAD_LEFT) }}</td>
                    </tr>
                    <tr>
                        <td class="meta-data">{{ __('field_name') }}</td>
                        <td class="meta-data value width2">: {{ $row->studentEnroll->student->first_name ?? '' }}
                    ...
                    <tr>
                        <td class="meta-data">Father Name</td>
                        <td class="meta-data value width2">: {{ $row->studentEnroll->student->father_name ?? '' }}</td>
                ...
                <td>- 
                    ...
                    {!! $setting->currency_symbol !!}
                        ...
                        <tr class="tfoot">
                            ...
                            <th>=
                                @if (isset($setting->decimal_place))
                                    {{ number_format((float) ($row->paid_amount + $row->fine_amount), $setting->decimal_place, '.', '') }}
                                @else
                ...
                <tbody>
                    <tr>
                        <td class="temp-logo">
                            <div class="inner">
                                @if (is_file('uploads/' . $path . '/' . $print->logo_left))
                                    <img src="{{ asset('uploads/' . $path . '/' . $print->logo_left) }}"
                                        alt="Logo">
                                @endif
                            </div>
                        </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            "use strict";
            console.log("File: print.blade.php");
            $.print(".printable");
        });
    </script>
