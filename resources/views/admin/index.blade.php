...
<div class="main-body">
    <div class="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-flare bitcoin-wallet">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-rainbow-blue bitcoin-wallet">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-dimigo bitcoin-wallet">
                    <div class="card-block">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-amin bitcoin-wallet">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-argon bitcoin-wallet">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-alihossein bitcoin-wallet">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-citrus bitcoin-wallet">
                    <div class="card-block">
