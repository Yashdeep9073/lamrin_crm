...
@section('content')
    <style>
        .gradient-background {
            background: linear-gradient(135deg, #3ea1e4, #ff7350, #125875);
            color: white;
    ...
    <div class="card">
        <div class="card-body text-center">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-group mb-3">
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                        ...
                        placeholder="{{ __('field_email') }}" autofocus>
                ...
                <div class="input-group mb-4">
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                        name="password" required autocomplete="current-password" placeholder="{{ __('field_password') }}">
            ...
            @isset($setting->copyright_text)
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://vibrantick.in/">
                    <div class="vibrantickLogo">
                        <img src="https://vibrantick.in/assets/images/logo/footer.png" alt="">
                    </div> 
                </a>
            @endisset
