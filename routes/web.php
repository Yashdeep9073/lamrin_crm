...
Route::middleware(['auth:web', 'XSS'])->name('admin.')->namespace('Admin')->prefix('admin')->group(function () {
    ...
    Route::get('fees-to-fees-transaction', 'FeesStudentController@migrateFeesData')->name('fees-student.migrate');
    ...
    Route::get('/student/{id}/fees', 'FeesStudentController@getStudentFees')->name('student.fees');
    // Route::get('/updatetotal/{id}/fees', 'FeesStudentController@updateTot')->name('student.fees');

    Route::get('/fetch-fees/{id}/fees', 'FeesStudentController@fetchFees')->name('fetch.fees');
